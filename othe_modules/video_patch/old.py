...
for i in road_ids:
    ...
    dl_link = f"https://raiotransection.s3.ap-south-1.amazonaws.com/{link}/output/{api}/videos/survey_{surveyid}/road_{i}/compressed_output.mp4"  #
    surveyroad = str(i)
